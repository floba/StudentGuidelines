...
\begin{figure}[h!]
	...
	\input{Images/Matlab2TikzExample.tikz}
...
For an Engineer's Internship Report, Seminar Paper or Researcher's Internship Report you are invited to use this IEEEtrans template (\LaTeX). You may also use article, report, scrartcl or scrreprt. For a bachelor or master thesis, you may use one of the four latter or book, or scrbook. Please have a close look into the source code of this document, to get a few tips on writing in \LaTeX\ (e.g.\ the tilde in \texttt{Fig.$\sim$\textbackslash{}ref\{key\}} to avoid a line break).
